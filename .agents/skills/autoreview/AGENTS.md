...
- Sync and validate the complete canonical directory, then omit tests, fixtures, and optional `scripts/test-review-harness*` wrappers from the Orka bundle. Reapply the three downstream overrides documented in `README.md`.
